...
CORS_ORIGIN_ALLOW_ALL = True  # legacy setting for django-cors-headers 2.5.3
...
MIDDLEWARE = [
    ...
    "api.cors_fallback_middleware.EnsureCORSHeadersMiddleware",
...
# Logging configuration (local) – mirrors base settings.
LOGGING = {
    "version": 1,
